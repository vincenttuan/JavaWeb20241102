...
<body>
	...
	<div class="content">
		<form class="pure-form" method="POST" action="/javaweb/user/register">
			<fieldset>
				<legend>會員註冊</legend>
				帳號: <input type="text" name="username" placeholder="請輸入帳號"
					required="required" />
				<p>
					密碼: <input type="text" name="password" placeholder="請輸入密碼"
						required="required" />
				<p>
					電郵: <input type="email" name="email" placeholder="請輸入電子郵件"
						required="required" />
				<p>
